...
//remember: do not use nested loop in this program b/c first we want to take the all elements at each index of the array and then in the 2nd loop we want to add it 